...
| `DJANGO_ALLOWED_HOSTS` | `172.20.10.15,localhost,127.0.0.1` | Hotes autorises |
...
| `CORS_ALLOWED_ORIGINS` | `http://172.20.10.15:5173` | Origines CORS |
...
| `FRONTEND_URL` | `http://172.20.10.15:5173` | URL utilisee dans les liens e-mail |
...
| `EDGE_BACKEND_API_URL` | `http://172.20.10.15:8000/api` |
