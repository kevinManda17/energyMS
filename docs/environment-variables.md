...
| `DJANGO_ALLOWED_HOSTS` | `192.168.84.117,localhost,127.0.0.1` | Hotes autorises |
...
| `CORS_ALLOWED_ORIGINS` | `http://192.168.84.117:5173` | Origines CORS |
...
| `FRONTEND_URL` | `http://192.168.84.117:5173` | URL utilisee dans les liens e-mail |
...
| `EDGE_BACKEND_API_URL` | `http://192.168.84.117:8000/api` |
