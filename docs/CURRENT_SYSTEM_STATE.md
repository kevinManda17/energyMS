...
| Élément | Valeur |
|---------|--------|
| Adresse LAN du PC | `172.20.10.15` |
| Backend (écoute) | `0.0.0.0:8000` (toutes interfaces) |
| Backend (accès) | `http://172.20.10.15:8000` |
| Frontend | `http://172.20.10.15:5173` |
| API | `http://172.20.10.15:8000/api` |
| Endpoint ESP32 | `http://172.20.10.15:8000/api/ems/decision/` |
...
|-----------|---------------------|-------|
| Backend | `LAN_HOST` (settings/base.py) | `172.20.10.15` |
| Frontend | `VITE_API_BASE_URL` (.env) | hôte de la page + `:8000/api` |
| Mobile | `EXPO_PUBLIC_API_BASE_URL` (.env) | `172.20.10.15` en dur |
...
```env
LAN_HOST=172.20.10.15
BACKEND_HOST=0.0.0.0
BACKEND_PORT=8000
API_BASE_URL=http://172.20.10.15:8000/api
FRONTEND_BASE_URL=http://172.20.10.15:5173
PUBLIC_APP_BASE_URL=http://172.20.10.15:5173
DJANGO_ALLOWED_HOSTS=172.20.10.15,localhost,127.0.0.1
CORS_ALLOWED_ORIGINS=http://172.20.10.15:5173,http://localhost:5173
...
```env
VITE_API_BASE_URL=http://172.20.10.15:8000/api
VITE_WS_URL=ws://172.20.10.15:8000/ws
```

### Mobile (`ems-mobile/.env`)

```env
EXPO_PUBLIC_API_BASE_URL=http://172.20.10.15:8000/api
EXPO_PUBLIC_EDGE_API_URL=http://172.20.10.15:8000/api
```
