"""
Base Django settings for the EMS platform.
...
# config/settings/base.py -> ems-backend/
...
LAN_HOST = os.getenv("LAN_HOST", "192.168.117.117")
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "API du système de gestion énergétique pour micro-réseau domestique intelligent.",
    "VERSION": "1.0.0",
